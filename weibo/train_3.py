...
LastEditTime: 2023-04-26 21:43:41
Reference: 
'''
...
joblib.dump(vectorizer,'./saved_model/TFIDF_3.model')
...
joblib.dump(clf_nb,'./saved_model/nb_model_3.model')
